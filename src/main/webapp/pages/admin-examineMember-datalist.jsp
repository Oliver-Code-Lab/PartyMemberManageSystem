...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="all-admin-index.html" class="logo">
            ...
            <span class="logo-lg"><b>审批积极分子</b>信息管理</span>
        </a>
                            ...
                            <c:forEach items="${members}" var="member">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick="details(${member.id})">详细</button>
                                    </td>
                                </tr>
                            </c:forEach>
