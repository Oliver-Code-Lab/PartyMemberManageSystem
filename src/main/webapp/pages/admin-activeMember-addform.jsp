...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="${pageContext.request.contextPath}/activeMember/addActiveMember" method="post">
                <div class="tab-pane" id="tab-common">
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input name="activeTime" type="text" class="form-control" placeholder="成为积极分子时间" value="">
                        </div>
