                        ...
                        <div class="box-tools pull-right">
                            <div class="input-group" style="width: 230px">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary btn-flat" onclick="search()">搜索</button>
                                </span>
                            </div>
                        </div>
                        <!--工具栏/-->
...
<%--                                </th>--%>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">入党时间</th>
                                <th class="sorting_desc sorting_desc_disabled">转正时间</th>
                                <th>身份证号</th>
                                <th>联系方式</th>
                                <th>家庭住址</th>
...
<%--                                    <td><input name="ids" type="checkbox"></td>--%>
                                    ...
                                    <td>${member.joinPartyTime}</td>
                                    <td>${member.formalTime}</td>
                                    <td>${member.idCard}</td>
                                    <td>${member.phone}</td>
...
<script>
    ...
    function search() {
        ...
        location.href = "${pageContext.request.contextPath}/partyMember/findPartyMemberByKeyword?keyword="+text;
    }

    function add() {
        location.href = "${pageContext.request.contextPath}/pages/admin-addform.jsp";
    }
    ...
    function updateIt(id) {
        ...
        location.href = "${pageContext.request.contextPath}/partyMember/OverWrite?id=" + id;
    }
    function deleteIt(id) {
        if(confirm("您确定删除吗?")) {
            $.get("${pageContext.request.contextPath}/partyMember/delete", {id: id}, function (flag) {
                if(flag == 1) location.href = "${pageContext.request.contextPath}/partyMember/findAll";
