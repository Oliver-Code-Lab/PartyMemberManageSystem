...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="${pageContext.request.contextPath}/partyMember/save" method="post">
            <div class="tab-pane" id="tab-common">
                <div class="row data-type">
                    ...
                    <input name="id" value="${partyMember.id}" type="hidden">
                    <div class="col-md-2 title">姓名</div>
                    <div class="col-md-4 image">
                        <input name="name" type="text" class="form-control" placeholder="姓名" value="${partyMember.name}">
                    </div>

                    <div class="col-md-2 title">性别</div>
                    <div class="col-md-4 data">
                        <input name="gender" type="text" class="form-control" placeholder="性别" value="${partyMember.gender}">
                    </div>

                    <div class="col-md-2 title">所属单位</div>
                    <div class="col-md-4 data">
                        <input name="deptment" type="text" class="form-control" placeholder="所属单位" value="${partyMember.deptment}">
                    </div>

                    <div class="col-md-2 title">入党时间</div>
                    <div class="col-md-4 data">
                        <input name="joinPartyTime" type="text" class="form-control" placeholder="入党时间" value="${partyMember.joinPartyTime}">
                    </div>

                    <div class="col-md-2 title">转正时间</div>
                    <div class="col-md-4 data">
                        <input name="formalTime" type="text" class="form-control" placeholder="转正时间" value="${partyMember.formalTime}">
                    </div>

                    <div class="col-md-2 title">身份证号</div>
                    <div class="col-md-4 data">
                        <input name="idCard" type="text" class="form-control" placeholder="身份证号" value="${partyMember.idCard}">
                    </div>

                    <div class="col-md-2 title">联系电话</div>
                    <div class="col-md-4 data">
                        <input name="phone" type="text" class="form-control" placeholder="联系电话" value="${partyMember.phone}">
                    </div>

                    <div class="col-md-2 title">家庭住址</div>
                    <div class="col-md-4 data">
                        <input name="address" type="text" class="form-control" placeholder="家庭住址" value="${partyMember.address}">
                    </div>
                    ...
                    <div class="col-md-10 data">
                        <div class="form-group form-inline">
                            <c:if test="${partyMember.status == '1'}">
                                ...
                                <div class="radio"><label><input type="radio" name="status" value="2"> 处分状态</label></div>
                            </c:if>

                            <c:if test="${partyMember.status == '2'}">
                                <div class="radio"><label><input type="radio" name="status" value="1"> 正常状态</label></div>
                                <div class="radio"><label><input type="radio" name="status" value="2" checked="checked"> 处分状态</label></div>
                            </c:if>
                        </div>
                    </div>
